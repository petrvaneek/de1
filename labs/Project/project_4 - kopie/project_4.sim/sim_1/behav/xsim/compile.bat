...
REM
REM Generated by Vivado on Thu Apr 28 16:18:49 +0200 2022
...
echo "xvhdl --incr --relax -prj alarm_tb_vhdl.prj"
call xvhdl  --incr --relax -prj alarm_tb_vhdl.prj -log xvhdl.log
